...
| `NC_S3_ACCESS_KEY` | No        | The AWS access key ID for the S3 storage plugin. Required if no IAM role access.                                                                                                                                    |                                         |
| `NC_S3_ACCESS_SECRET` | No        | The AWS access secret associated with the S3 storage plugin. Required if no IAM role access.                                                                                                                                                       |                                         |
